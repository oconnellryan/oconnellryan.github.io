...
<div style="display: flex; gap: 12px; flex-wrap: wrap; margin-bottom: 24px;">
  <a href="#ufc-graphics" style="...button styles...">🥊 UFC Graphics</a>
  <a href="#mlb-graphics" style="...button styles...">⚾ MLB Graphics</a>
  <a href="#twitter-content" style="...button styles...">🐦 Twitter Content</a>
  <a href="#photoshop" style="...button styles...">🎨 Photoshop</a>
</div>
...
<h2 id="ufc-graphics" style="margin-top: 40px;">🥊 UFC Graphics</h2>
